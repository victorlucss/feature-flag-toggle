...
import * as apiKeyConfig from '../config/middleware/apiKey';
import * as swaggerUi from 'swagger-ui-express';
import AuthRouter from './AuthRouter';
import ApiKeyRouter from './ApiKeyRouter';
import FeatureFlagRouter from './FeatureFlagRouter';
...
export function init(app: express.Application): void {
    ...
    app.use('/v1/apikey', ApiKeyRouter);
    app.use('/v1/ff', apiKeyConfig.isValidAPIKey, FeatureFlagRouter);
